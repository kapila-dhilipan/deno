...
const AssignDemandModal = (props) => {
  ...
  const {isModalOpen,setIsModalOpen,showMessageBar,setShowMessageBar, data} = props;

	console.log(props.assignDemandId)

	const [checkedAssignee, setCheckedAssignees] = useState(data);
					...
					<div className={styles.header_content_container}>
						<div className={styles.header_content_job_description_unassigned_save_container}>
							...
							{/* <div className={styles.header_save_close_btns_container}>
								...
								<PrimaryButton onClick={closeHandler}  text="Save & Close" iconProps={{iconName:"Save"}}/>
							...
							<tbody>
								...
								checkedAssignee.length ? checkedAssignee.map(assignee=>{
									...
									return(
										...
										<tr  className={styles.table_row}>
											<td className={styles.table_dataContents}> <input key={`CA${assignee._id}`} type="checkbox" checked  ></input> </td>
